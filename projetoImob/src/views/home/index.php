    ...
    <div class="mask">
        <div class="container">
            <div class="box-12 mg-t-10">
                <h2 class="fonte60 espaco-letra txt-c fnc-branco mg-t-4">Sua casa a um click!</h2>
                <span class="block txt-c fnc-branco uppercase fonte30 fw-300">Oportunidade Casa Web</span>
                <a href="index.php?controller=PainelController&method=index" class="btn bg-vermelho fnc-branco mg-auto mg-t-4 bg-vermelho-claro-hover">Saiba mais</a>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="comprar">
                <a href="">
                    <div class="fundo flex justify-center item-centro">
                        <h3 class="fonte68 espaco-letra fw-900 fnc-branco capitalize fnc-vermelho-claro-hover">Comprar</h3>
                    </div>
                </a>
            </div>
            <div class="alugar">
                <a href="">
                    <div class="fundoa flex justify-center item-centro">
                        <h3 class="fonte68 espaco-letra fw-900 fnc-branco capitalize fnc-preto-azulado-hover">Alugar</h3>
                    </div>
                </a>
...
<section class="depoimentos mg-t-10" id="depoimentos">
    <div class="container">
        <div class="box-12 bg-preto-azulado-escuro flex justify-center item-centro pd-40">
            <!-- animação do slide se encontra no header do site, com aplicação do efeito sobre o nome das classes-->
            <div class="carousel">
                <div class="slides">
                    <div class="slide">
...
<section class="paralax">
    <div class="container">
        <div class="box-12 hg-80 bg-preto-azulado-escuro"></div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="box-12 flex justify-center item-centro mg-t-4">
            <div class="box-3 txt-c">
                <i class="fa-solid fa-phone fonte56 fnc-vermelho-claro"></i><br><br>
            ...
            <div class="box-3 txt-c">
                <i class="fa-solid fa-location-dot fonte56 fnc-vermelho-claro"></i><br><br>
            ...
            <div class="box-3 txt-c">
                <i class="fa-solid fa-envelope fonte56 fnc-vermelho-claro"></i> <br><br>
