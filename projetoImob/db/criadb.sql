...
-- CRIAÇÃO DO USUÁRIO DE TESTES
---- fonte: https://www.digitalocean.com/community/tutorials/how-to-create-a-new-user-and-grant-permissions-in-mysql

create user 'tester'@'localhost' identified by '123456';
grant all privileges on casaweb to 'tester'@'localhost';
